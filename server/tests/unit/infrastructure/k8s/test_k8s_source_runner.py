"""Unit tests for K8sSourceRunner — Job spec differences, source lifecycle."""
...
def _make_source(
    ...
    return SourceDefinition(
        ...
        digest=digest,
        config=config,
        limits=SourceLimits(timeout_seconds=timeout, memory=memory, cpu=cpu),
    )
...
# ---------------------------------------------------------------------------
# Identity threading from SourceInputs
# ---------------------------------------------------------------------------
